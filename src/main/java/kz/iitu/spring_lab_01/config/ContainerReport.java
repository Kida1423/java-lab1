	...
	public void run(String... args) {
		...
		Arrays.stream(context.getBeanDefinitionNames())
				.filter(name -> name.startsWith("kz.iitu") || name.contains("Notifier")
						|| name.contains("notifier") || name.equals("console")
						|| name.equals("email") || name.equals("noop")
						|| name.equals("reversed") || name.equals("notificationService")
						|| name.equals("lifecycleDemo") || name.equals("ticketOffice")
						|| name.equals("reportDateFormatter"))
